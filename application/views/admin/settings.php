    ...
    echo form_dropdown('siteLang', $data, $s['siteLang'], $att);?>
            ...
            <hr />
				...
				<div class="form-group">
					...
					<div class="controls">
						<div><img src="<?php if ($s['siteLogo'] != "") {echo '/assets/images/' . $s['siteLogo'];}?>" id="logo_preloaded" <?php if ($s['siteLogo'] == "") {echo "style='display:none;'";}?>></div>
						<img src="/theme/admin/images/ajax-loader.gif" style="margin:-7px 5px 0 5px;display:none;" id="loading_pic" />
						<?php
$data = array(
        'name'  => 'file_upload',
        'id'    => 'file_upload',
    ...
    ?>
              ...
              <hr />
               <div class="form-group">
					...
					<div class="controls">
						<div><img src="<?php if ($s['siteFavicon'] != "") {echo '/assets/images/' . $s['siteFavicon'];}?>" id="favicon_preloaded" <?php if ($s['siteFavicon'] == "") {echo "style='display:none;'";}?>></div>
						<img src="/theme/admin/images/ajax-loader.gif" style="margin:-7px 5px 0 5px;display:none;" id="loading_pic_favicon" />
						<?php
$data = array(
        'name'  => 'favicon_upload',
        'id'    => 'favicon_upload',
